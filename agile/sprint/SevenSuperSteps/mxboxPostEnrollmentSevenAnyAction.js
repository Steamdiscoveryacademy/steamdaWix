...
// ø FIND superSeven202107 ANY-ACTION
export async function mxboxPostEnrollmentSevenAnyAction(responseObject = {}){
    ...
    // ø </ELSE>
// ø FIND superSeven202107 YES_ANY_ACTION if it's HERE it belongs in Any Action
    DOX = '</YES_ANY_ACTION>'
    ...
    // ø FIND superSeven202107 MAYBE_CURRENT_ACTION if it's BELOW it belongs in NEXT subScript
    ...
    // ø FIND superSeven202107 JSON-PARSE
...
// ø FIND superSeven202107 END-ANY-ACTION
// ø <---------- </mxboxPostEnrollmentSevenAnyAction> ---------->
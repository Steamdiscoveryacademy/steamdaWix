...
export function manualEntryTitles(peSevenObject) {
     ...
     */
        ...
        // ø </step titles manual>
        peSevenObject.titleKeyArray = titleKeyArray
...
export function buildStepObjectArrayBase(peSevenObject) {
    let titleKeyArray = peSevenObject.titleKeyArray;
    ...
    for (let index = 0; index < titleArray.length; index++) {
        let titleKeyThis = typeof titleKeyArray[index] === 'undefined' ? '' : titleKeyArray[index];
        ...
        if (titleKeyThis.length === 0){
            ...
            stateIdThis += titleKeyThis.substr(0,1).toUpperCase() + titleKeyThis.substr(1);

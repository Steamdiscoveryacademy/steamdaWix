...
paramStepLogString = "info=The 'IINSTANTIATE' Step has an Info Override UI==FFALSE=stateInstantiate=IINSTANTIATE|danger=danger in end of ui force==FFALSE=stateInstantiate=IINSTANTIATE|";

let messageObjectArraysByKey = parsePPEQ_toObjectArraysByKey(paramStepLogString);

console.warn('paramStepLogString: ');
...
console.warn(paramStepLogStringDisplay);


console.warn('messageObjectArraysByKey: ');
console.warn(messageObjectArraysByKey);
console.warn(JSON.stringify(messageObjectArraysByKey,undefined,4));

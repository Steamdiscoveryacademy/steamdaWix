...
let idToLableKeyArray = [['custom.w0-2021010102','0101','0102'],['custom.w1-2021060711','0607','0611'],['custom.w2-2021061418','0614','0618'],['custom.w3-2021062125','0621','0625'],['custom.w4-2021062832','0628','0702'],['custom.w5-2021071216','0712','0716'],['custom.w6-2021071923','0719','0723'],['custom.w7-2021072630','0726','0730'],['custom.w8-2021080206','0802','0806'],['custom.w9-2021080913','0809','0813']];
...
for (let index = 0; index < courseArray.length; index++) {
    ...
    labelKey = idToLableKeyArray[element.weekId][0];
    finalLabelKeyArray.push(labelKey);
    beginBDAY = idToLableKeyArray[element.weekId][1];
    endBDAY = idToLableKeyArray[element.weekId][2];

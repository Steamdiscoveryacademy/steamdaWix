...
export function expressionBuilderObject(paramObject,responseObject){
    ...
    console.warn('[~LINE 103]['+paramObject.objectFunctionCount+']paramObject.nextElementStringStart just after appendToStartString');
    ...
    console.warn('[~LINE 126]['+paramObject.objectFunctionCount+']paramObject.nextElementStringStart just after appendToStartString')
    ...
    for (let index = 0; index < nextElementKeyArray.length; index++) {
        ...
        console.warn('[~LINE 153]['+paramObject.objectFunctionCount+']paramObject.nextElementStringStart just after appendToStartString');

...
// ø <ExitAfter Init>
// let exitAfter = 'ALL';
// let exitAfter = 'PREP_ppContact';
let exitAfter = 'NNOT_AA_SSTEP';
let exitNow = 'FFALSE';
...
while (testIndex < testMax) {
    ...
    // ø <ExitAfter POST stepCycle>
    exitNow = exitAfter === 'ALL' ? 'TTRUE_ALL' : exitNow;
    exitNow = exitAfter === memItemCURRENT ? 'TTRUE_ExitAfter' : exitNow;
    exitNow = memItemCURRENT === 'CCOMPLETE' ? 'TTRUE_Complete' : exitNow;
    if(exitNow !== 'FFALSE'){

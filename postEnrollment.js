 ...
 * ! ===============================
 ...
 // ø pstEnrSevenORIG202108 = work surrounding pstEnrSeven
...
export async function mxboxPostEnrollmentSevenAnyAction(responseObject = {}) {
    ...
    // ! <StampKLUDGE> cannot, at this time, touch nowISO() to do this better
    // responseObject.stamp = await nowISO(local.getItem('timezoneOffset'),local.getItem('tzAbbrv'));
    responseObject.stamp = await isoKLUDGE();
    // ! </StampKLUDGE>

    responseObject.any = {};
    responseObject.any.testingStampBorderISO = '2021-12-31T23:59:59';
    responseObject.any.testingStampAsIfISO = '2021-07-27T12:26:59';
    // if(/*<BEFORE>*/ responseObject.any.testingStampAsIfISO < responseObject.any.testingStampBorderISO){}
    //  if(/*<AFTER>*/ responseObject.any.testingStampAsIfISO > responseObject.any.testingStampBorderISO){}
    // if(/*<CONFIRMED>*/ responseObject.any.testingStampAsIfISO !== responseObject.any.testingStampBorderISO){}
    responseObject.next = {};
    responseObject.next.testingStampBorderISO = '2021-12-31T23:59:59';
    responseObject.next.testingStampAsIfISO = '2021-07-27T12:26:59';
    // if(/*<BEFORE>*/ responseObject.next.testingStampAsIfISO < responseObject.next.testingStampBorderISO){}
    //  if(/*<AFTER>*/ responseObject.next.testingStampAsIfISO > responseObject.next.testingStampBorderISO){}
    // if(/*<CONFIRMED>*/ responseObject.next.testingStampAsIfISO !== responseObject.next.testingStampBorderISO){}
    responseObject.perform = {};
    responseObject.perform.testingStampBorderISO = '2021-12-31T23:59:59';
    responseObject.perform.testingStampAsIfISO = '2021-07-27T12:26:59';
    // if(/*<BEFORE>*/ responseObject.perform.testingStampAsIfISO < responseObject.perform.testingStampBorderISO){}
    //  if(/*<AFTER>*/ responseObject.perform.testingStampAsIfISO > responseObject.perform.testingStampBorderISO){}
    // if(/*<CONFIRMED>*/ responseObject.perform.testingStampAsIfISO !== responseObject.perform.testingStampBorderISO){}
    ...
    let peSevenStateCurrentId = '';
    let panelNotesKey = 'PPENDING';
    // ø </Pre-Trash but innocuous>
    if (responseObject.button === 'CURRENT') {
        // ø <button === CURRENT> fromSoupToNuts
    ...
    responseObject.logArrayDeveloper.push(`let lastClicked = memory.getItem('msboxLastState') [${memory.getItem('msboxLastState')}] === peSevenStateCurrentId [${peSevenStateCurrentId}] ? 'PERFORM_STEP' : 'NEXT_STATE';`);
    responseObject.logArrayDeveloper.push('≈ 3901 ≈ ∆ lastClicked === ' + lastClicked + ' ∆');
    ...
    $w('#spDatabaseResponseJSON').value = JSON.stringify(responseObject, undefined, 4);
    // ! <Call 'PERFORM' Sequence>
    responseObject.logArrayDeveloper.push(`≈ 3953 ≈ ◊ lastClicked === ${lastClicked} ◊`);
    if (lastClicked === 'PERFORM_STEP') {
        responseObject.logArrayDeveloper.push('≈ 3955 ≈ ◊ lastClicked === PERFORM_STEP ◊');
        responseObject.currentStepOriginalStepsArray = currentStepOrigStepsObject.allStepArray;
        await mxboxPostEnrollmentSevenPerformStepUI(responseObject);
    }
    // ! </Call 'PERFORM' Sequence>
    ...
    if (lastClicked === 'NEXT_STATE') {
        responseObject.logArrayDeveloper.push('≈ 3963 ≈ ◊ lastClicked === NEXT_STATE ◊');
...
export async function mxboxPostEnrollmentSevenPerformStepUI(responseObject = {}) {
    // pstEnrSevenORIG202108 PERFORM-UI BEGIN
    // pstEnrSevenNEW202108 PERFORM-UI BEGIN
...
export async function mxboxPostEnrollmentSevenPerformStepDO(responseObject = {}) {
    // pstEnrSevenORIG202108 PERFORM-DO BEGIN
    // pstEnrSevenNEW202108 PERFORM-DO BEGIN

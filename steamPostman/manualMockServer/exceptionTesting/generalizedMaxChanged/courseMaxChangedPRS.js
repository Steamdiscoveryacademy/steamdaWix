...
if(blockSetName === 'BASE'){
    ...
    // » <BASE>
    // » <BASE Obama>
    pm.globals.set("courseMaxChanged", "2008-01-20T12:00:00+0000") /* ø NOTE: drupal.changed ISO format*/
    pm.globals.set("courseMaxChangedGathered", "2022-12-01T23:59:59.001Z") /* ø NOTE: postman {{$isoTimestamp}} ISO format*/

    console.log(`PRS: [${blockSetName}] pm.globals.get("courseMaxChanged"): ${pm.globals.get("courseMaxChanged")}`)
    // » </BASE Obama>
    // » </BASE>
    // » </>
...
if(blockSetName === 'SPECIFIED_TARGET'){
    ...
    // pm.globals.set("courseMaxChanged", "2022-11-16T23:59:59+0000")
    // pm.globals.set("courseMaxChangedGathered", "2022-12-01T23:59:59.002Z")

    pm.globals.set("courseMaxChanged", "2022-11-28T06:37:36+0000")
    pm.globals.set("courseMaxChangedGathered", "2022-12-03T14:03:19.764Z")
...
if(blockSetName === 'NORMAL_ITERATIVE_STEPPING'){
    ...
    pm.globals.set("courseMaxChanged", "2022-11-28T06:37:36+0000")
    pm.globals.set("courseMaxChangedGathered", "2022-12-03T13:16:07.223Z")
...
console.log(`PRS:[${blockSetName}] pm.globals.get("courseMaxChanged"): ${pm.globals.get("courseMaxChanged")} (immediately before exiting)`)
